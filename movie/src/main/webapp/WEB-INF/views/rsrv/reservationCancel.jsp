...
#movieBox{ min-height: 450px;}
#movieInfo card-body {height:350px; border: none; padding-bottom: 0; margin-bottom: 0;}
#info {min-height:190px}
									...
									<div class="col-md-7">
										<div class="card-body pt-1 pr-1">
											<ul class="list-group list-group-horizontal">
											  ...
											  <li class="list-group-item py-2 pl-3  font-weight-bold" 	id="orderId">취소된 예매 내역입니다.</li>
											</ul>
											<ul class="list-group list-group-horizontal">
