					...
					<div class="card-body">
							...
							<div class="form-group">
								<label for="board_writer_name">작성자</label> <input type="text"
									...
									class="form-control" value="${movie.movie_nm}" disabled="disabled" />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<textarea id="board_content" name="board_content"
									...
									disabled="disabled">${movie.movie_nm}</textarea>
							</div>
				 ...
				 -->
						...
						<div class="form-group">
							<div class="text-right">
								...
								<a href="./quesboard_rewrite?ques_no=${qrlist.ques_no}" class="btn btn-info">등록하기</a>
