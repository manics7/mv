...
@SequenceGenerator (name = "SCHEDULE_DETAIL_SEQ_GENERATOR", sequenceName = "SCH_DETAIL_SEQ", initialValue = 1, allocationSize = 1)
public class ScheduleDetail {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SCHEDULE_DETAIL_SEQ_GENERATOR")
