...
drop table mv_official cascade constraints;
CREATE TABLE mv_Official (
	movie_Cd	NVARCHAR2(50)		NULL,
	movie_Nm	NVARCHAR2(50)		NULL,
...
COMMENT ON COLUMN mv_Official.movie_Cd IS '영화코드를 출력합니다.';
...
CREATE TABLE review_file (
	...
	review_num	NUMBER		NULL,
	review_file_prevame	NVARCHAR2(200)		NULL,
...
ALTER TABLE mv_Official ADD CONSTRAINT PK_MVOFFICIAL PRIMARY KEY (
	movie_Cd
);
